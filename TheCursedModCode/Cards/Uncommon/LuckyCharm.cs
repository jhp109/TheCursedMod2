...
/// <summary>
/// 액땜 부적(Lucky Charm) - 저주 카드가 소멸될 때 마다, 방어도를 4 얻습니다. (강화 시 방어도 5)
/// </summary>
public sealed class LuckyCharm() : TheCursedModCard(1, CardType.Power, CardRarity.Uncommon, TargetType.None)
{
