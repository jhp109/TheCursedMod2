...
/// <summary>
/// 급소 타격(Vital Strike) - 피해를 7 줍니다. 취약을 2 부여합니다. 업보 3. (강화 시 피해 9, 취약 3)
/// </summary>
public sealed class VitalStrike() : TheCursedModCard(0, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy), IKarmaAttack
{
    protected override HashSet<CardTag> CanonicalTags => [CardTag.Strike];
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new DamageVar(7, ValueProp.Move),
        new PowerVar<VulnerablePower>("VulnerablePower", 2),
        new PowerVar<KarmaTurn2Power>("KarmaPower", 3m)
    ];
